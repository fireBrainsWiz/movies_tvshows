...
export default function PopularMoviesOrTVshows({links}) {
  ...
  const checkIfNextIsAvailable = useCallback( async (scw) => {
    ...
    const res = await axios(`${links.TOPLINKS.POPULAR}${nOfSlides+1}`, TMDBOptions)
  ...
  return (
    <>
      ...
      <div className="min-h-[800px]p bg-sky-900p my-2">
        <h2 className="text-3xl font-bold mb-4 text-center">Most Popular</h2>
